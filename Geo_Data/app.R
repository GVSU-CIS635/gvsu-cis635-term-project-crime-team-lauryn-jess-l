    ...
    tabPanel("Interactive Map",
             fluidRow(width = 2, 
                      #radioButtons(
                        ...
                        #choices = c("None selected" = "", "2012", "2013", "2014", "2015", "2016", "2017"),
